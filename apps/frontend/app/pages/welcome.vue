...
.welcome-page {
  ...
  align-items: center;
  min-height: 100vh;
  background: linear-gradient(135deg, var(--color-surface) 0%, rgba(228, 35, 19, 0.03) 100%);
  ...
  &__feature {
    ...
    &:hover {
      ...
      box-shadow: 0 20px 40px rgba(228, 35, 19, 0.08);
      border-color: rgba(228, 35, 19, 0.2);
    }
  }
